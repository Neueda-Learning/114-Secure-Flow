...
class DashboardShellTest {
    ...
    void servesTheDashboardShell() throws Exception {
        mockMvc.perform(get("/index.html"))
                ...
                .andExpect(content().string(containsString("India monitoring desk")))
                .andExpect(content().string(containsString("Processed in INR")))
                .andExpect(content().string(containsString("15,000 payment")))
